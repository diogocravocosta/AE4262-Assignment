...
ax.plot(phis, speeds, 'o-', color='#2980b9', markersize=8, linewidth=2)
ax.set_xlabel('Equivalence ratio φ', fontsize=13)
ax.set_ylabel('Laminar flame speed S$_L$ [m/s]', fontsize=13)
ax.set_title('H$_2$/air – 1 atm, 300 K', fontsize=14)
ax.grid(True, alpha=0.3)
fig.tight_layout()
fig.savefig('flame_speed_h2.png', dpi=150)
plt.show()
print("\nPlot saved to flame_speed_h2.png")