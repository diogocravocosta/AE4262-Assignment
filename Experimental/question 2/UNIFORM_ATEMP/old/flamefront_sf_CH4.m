function results = flamefront_sf_CH4(filenames, px2mm_x, px2mm_y, threshold, drop_frac, trunc_frac, velocities, verbose_diag, verbose_overlay)
% FLAMEFRONT_SF_CH4  Batch flame speed for CH4 using unified gradient-guided detection.
%
%   Inputs:
