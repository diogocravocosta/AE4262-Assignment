...
# Allow running as a direct file (python h2_flame_sim/__main__.py)
# as well as a module (python -m h2_flame_sim)
...
def main():
    ...
    parser.add_argument(
        ...
        help="Spatial coordinate for plots (default: x_shifted). "
             "'c' is the progress variable (0=reactants, 1=products), the premixed analogue of Z."
    )
    parser.add_argument(
    ...
    sim._load_gas()  # will warn and fall back to gri30.yaml if h2o2.yaml is missing
